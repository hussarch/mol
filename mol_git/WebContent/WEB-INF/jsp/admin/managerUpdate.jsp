...
<body>
	...
	<section style="height: 310px; width: 480px; margin-top: 80px;" class="content">
		<form:form commandName="manager" action="updateManager.do" id="setPositionForm" method="post" onsubmit="return check();">
			<form:hidden path="id"/>
							...
							<tr>
								<td>
									...
									<form:select path="superManager.id">
                                        <option></option>
                                        <form:options items="${managerList}" itemLabel="user.name" itemValue="id"/>  
                                    </form:select>
								</td>
							</tr>
							<tr>
								<td align="right" style="padding-right: 38px; height: 60px;">
									<input type="button" class="blueButton" value="取消" onclick="window.location = '<spring:url value='/admin/managerList.do'/>'">
